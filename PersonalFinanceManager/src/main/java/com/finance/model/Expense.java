...
public class Expense {
    ...
    private int id; // corresponds to expense_id in DB
    private int userId;
    ...
    // Constructor for new expense (ID will be generated by DB)
    ...
    // Constructor with ID (for existing expense fetched from DB)
